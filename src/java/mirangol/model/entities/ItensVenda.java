...
@NamedQueries({
    ...
    , @NamedQuery(name = "ItensVenda.findByPrecoCompra", query = "SELECT i FROM ItensVenda i WHERE i.precoCompra = :precoCompra")
...
public class ItensVenda implements Serializable {
    ...
    public String toString() {
        return "mirangol.model.entities.ItensVenda[ idItensVenda=" + idItensVenda + " ]";
    }
